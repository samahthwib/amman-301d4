...
function displayPics(){
  ...
  // When we changed it to the let it gave us an error because the let is a block element and it is only available
  // for use whithin that block, and here we call it out the block
  console.log(viewed);
